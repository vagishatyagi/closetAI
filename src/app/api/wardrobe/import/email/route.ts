...
const EMAIL_RECEIPT_MOCK_ITEMS = [
  ...
  },
  {
    ...
    orderNumber: 'CM-203948',
    subject: 'Your Club Monaco Order #CM-203948 Confirmation',
    category: 'Top',
    sub_category: 'Cashmere Crewneck',
  ...
  },
  {
    ...
    orderNumber: 'RL-102938',
    subject: 'Thank you for your Ralph Lauren order! #RL-102938',
    category: 'Bottom',
    sub_category: 'Pleated Trousers',
    color_family: 'Chocolate Brown',
    pattern: 'Solid',
    fabric: 'Wool Blend',
    formality: 'Smart Casual',
    min_temp: 45,
  ...
  {
    retailer: 'Adidas',
    orderNumber: 'AD-827364',
    subject: 'Your Adidas Order #AD-827364 is Confirmed',
    category: 'Footwear',
    sub_category: 'Retro Sneakers',
